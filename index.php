	...
	<div class="b-block">
		...
		<div class="b-useful-info-list slider-cont mobile-slider">
			<div class="b-useful-info-item">
				<a href="#" class="b-img" style="background-image: url(<?=SITE_TEMPLATE_PATH?>/html/i/info-1.jpg);">
					<div class="border-orange-div"></div>
					<div class="b-useful-read-more">Читать подробнее</div>
				</a>
				<div class="date">24 июля 2020 г.</div>
				<a href="#"><h4>Почему стоит доверить подбор автомобиля профессионалам?</h4></a>
				<p>Приобретение подержанного транспортного средства с большим пробегом зачастую связано с огромным количеством рисков…</p>
			</div>
			<div class="b-useful-info-item">
				<a href="#" class="b-img" style="background-image: url(<?=SITE_TEMPLATE_PATH?>/html/i/info-2.jpg);">
					<div class="border-orange-div"></div>
					<div class="b-useful-read-more">Читать подробнее</div>
				</a>
				<div class="date">13 июля 2020 г.</div>
				<a href="#"><h4>Лучшие семейные автомобили</h4></a>
			...
			<div class="b-useful-info-item">
				<a href="#" class="b-img" style="background-image: url(<?=SITE_TEMPLATE_PATH?>/html/i/info-3.jpg);">
					<div class="border-orange-div"></div>
					<div class="b-useful-read-more">Читать подробнее</div>
				</a>
				<div class="date">28 июня 2020 г.</div>
				<a href="#"><h4>Что такое комиссионная продажа автомобиля?</h4></a>
			...
			<div class="b-useful-info-item">
				<a href="#" class="b-img" style="background-image: url(<?=SITE_TEMPLATE_PATH?>/html/i/info-4.jpg);">
					<div class="border-orange-div"></div>
					<div class="b-useful-read-more">Читать подробнее</div>
				</a>
				<div class="date">9 мая 2020 г.</div>
				<a href="#"><h4>Оценка стоимости авто для продажи</h4></a>
