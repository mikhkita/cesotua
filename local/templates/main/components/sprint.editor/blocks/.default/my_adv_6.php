...
<div class="b b-2 b-2-6">
	<div class="b-block">
		...
		<div class="b-sale-list slider-cont mobile-slider">
			...
			<div class="b-sale-item">
				<img src="<?=SITE_TEMPLATE_PATH?>/html/i/number-5.svg">
				<?if(!empty(Sprint\Editor\Blocks\Text::getValue($block['link-5']))):?>
					<a href="<?=Sprint\Editor\Blocks\Text::getValue($block['link-5'])?>">
			...
			<div class="b-sale-item">
				<img src="<?=SITE_TEMPLATE_PATH?>/html/i/number-6.svg">
				<?if(!empty(Sprint\Editor\Blocks\Text::getValue($block['link-6']))):?>
					<a href="<?=Sprint\Editor\Blocks\Text::getValue($block['link-6'])?>">
						<h3><?=Sprint\Editor\Blocks\Text::getValue($block['title-6'])?></h3>
					</a>
				<?else:?>
					<h3><?=Sprint\Editor\Blocks\Text::getValue($block['title-6'])?></h3>
				<?endif;?>
